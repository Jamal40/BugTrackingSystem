...
namespace BugTrackingSystem.Migrations
{
    ...
    [Migration("20210501135425_AddingUserPojectRelations")]
    partial class AddingUserPojectRelations
    {
            ...
            modelBuilder.Entity("BugTrackingSystem.Models.BugTrackerUser", b =>
                {
                    ...
                    b.Property<int?>("ManagedPrjectID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BugTrackingSystem.Models.BugTrackerUser", b =>
                {
                    b.HasOne("BugTrackingSystem.Models.Project", "ManagedProject")
                        .WithMany()
                        .HasForeignKey("ManagedPrjectID");

                    b.HasOne("BugTrackingSystem.Models.Project", "Project")
                        .WithMany("Developers")
                        .HasForeignKey("PrjectID");
